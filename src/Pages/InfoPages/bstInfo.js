...
const bstInfo = [
    {
        ...
        description: "A binary search tree (BST) is a binary tree in which all left descendants of a node are less than the node value, and all right descendants are greater than the node value. This property allows efficient search, insertion, and deletion operations.",
    ...
    },
    {
        ...
        description: "Traversal methods visit all nodes of the BST in a specific order without modifying the tree structure.",
    },
    {
