...
import './App.css';
import Sorting from './SortingAlgorithms/Sorting/Sorting';
import LinkedList from './SortingAlgorithms/Linked List/LinkedList';
...
const App = () => (
  ...
  <Routes>
    ...
    <Route path="/LinkedList" exact component={<LinkedList />} />
    {/* <Route path="/sorting/Bubble" component={SortingVisualization} /> */}
  </Routes>
